...
void left_turn_calibration(DC_motor *mL, DC_motor *mR){
    ...
    if(!PORTFbits.RF2){left_timer += 5;LATDbits.LATD7 = 1;_delay((unsigned long)((200)*(64000000/4000.0)));LATDbits.LATD7 = 0;}
    else if(!PORTFbits.RF3){left_timer -= 5;LATHbits.LATH3 = 1;_delay((unsigned long)((200)*(64000000/4000.0)));LATHbits.LATH3 = 0;}
    _delay((unsigned long)((2000)*(64000000/4000.0)));
    }
}
...
void right_turn_calibration(DC_motor *mL, DC_motor *mR){
    while (!(!PORTFbits.RF3 && !PORTFbits.RF2)) {
        ...
        if(!PORTFbits.RF2){right_timer += 5;LATDbits.LATD7 = 1;_delay((unsigned long)((200)*(64000000/4000.0)));LATDbits.LATD7 = 0;}
        else if(!PORTFbits.RF3){right_timer -= 5;LATHbits.LATH3 = 1;_delay((unsigned long)((200)*(64000000/4000.0)));LATHbits.LATH3 = 0;}
        _delay((unsigned long)((2000)*(64000000/4000.0)));
        }
}
