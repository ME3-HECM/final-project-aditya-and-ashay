...
void instructions(DC_motor *mL, DC_motor *mR, int count)
{
    ...
    if (count == 4){reverse(mL,mR); _delay((unsigned long)((700)*(64000000/4000.0)));stop(mL,mR);_delay((unsigned long)((500)*(64000000/4000.0)));right_45(mL,mR,2,right_timer); stop(mL,mR);}
    if (count == 5){reverse(mL,mR); _delay((unsigned long)((700)*(64000000/4000.0)));stop(mL,mR);_delay((unsigned long)((500)*(64000000/4000.0)));left_45(mL,mR,2,left_timer); stop(mL,mR);}
